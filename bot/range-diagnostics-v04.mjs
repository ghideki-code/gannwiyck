...
console.log(JSON.stringify({source:"Binance Spot REST /api/v3/klines",symbol:SYMBOL,limit:LIMIT,pivotLen:PIVOT_LEN,minBars:MIN_BARS,maxBars:MAX_BARS,minMidTouches:MIN_MID_TOUCHES,results:out},null,2));
